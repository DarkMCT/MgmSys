    ...
    search = ()=>{
        ...
        if ((cpf.length === 11 && isNumber(+cpf)) || (rg.length === 8 && isNumber(+rg))){
            ...
            fetch(this.props.backendAddr + "/visita_visitante/search", {
                ...
                method: "POST",
                mode: "cors",
                body: JSON.stringify({cpf: cpf, rg: rg, what: "RG_CPF"}),
            }).then( res =>{
                return res.json();
            }).then( data => {
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="form-group col-6">
                        ...
                        <input
                            type="text" id="visitante_rg" ref={ this.visitante_rg } className="form-control" placeholder="Digite o RG do visitante..."
                            value={this.state.rg} onBlur={this.search} onChange={(e)=>this.setState({rg: e.target.value})}>
                        </input>
                        <small className="form-text text-muted">Ex: 0000000-00, 000000000</small>
                    </div>

                    <div className="form-group col-6">
                        <label htmlFor="visitante_cpf">CPF</label>
                        <input
                            type="text" id="visitante_cpf" ref={this.visitante_cpf} className="form-control" placeholder="Digite o CPF do visitante..."
                            value={this.state.cpf} onBlur={this.search} onChange={(e)=>this.setState({cpf: e.target.value})}>
                        </input>
                        <small className="form-text text-muted">Ex: 000.000.000-00, 00000000000</small>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="form-group col-6">
                        ...
                        <input
                            type="text" id="visitante_nome" ref={this.visitante_nome} className="form-control" placeholder="Digite o nome do visitante..."
                    ...
                    <div className="form-group col-6">
                        ...
                        <input
                            type="text" id="visitante_email" ref={this.visitante_email} className="form-control" placeholder="Digite o email do visitante..."
                ...
                <div className="row">
                    <div className="form-group col-6">
                        ...
                        <input
                            type="date" id="visitante_dt_nasc" ref={this.visitante_dt_nasc} className="form-control" placeholder="Digite a data de nascimento do visitante..."
                    ...
                    <div className="form-group col-6">
                        ...
                        <input
                            type="text" id="visitante_telefone" ref={this.visitante_telefone} className="form-control" placeholder="Digite o telefone do visitante..."
                ...
                <div className="row">
                    <div className="form-group col">
                        ...
                        <input
                            type="text" id="visitante_endereco" ref={this.visitante_endereco} className="form-control" placeholder="Digite o endereço do visitante..."
                ...
                <div className="row pt-3">
                    <div className="col-6">
                        {/* <button className="btn btn-secondary float-left">Voltar</button> */}
                    </div>
                    <div className="col-6">
